    ...
    <div class="cart-sidebar">
      ...
      <div class="cart-footer" id="cart-footer" style="display:none;">
        ...
        <button class="button_1 cart-checkout-btn" id="cart-checkout-btn">
          <i class="fas fa-university"></i> Proceed to Checkout
        </button>
      </div>
    </div>
  `;
  ...
  modal.innerHTML = `
    ...
    <div class="checkout-panel">
      <div class="checkout-header">
        <h2><i class="fas fa-university"></i> Place Your Order</h2>
      ...
      <div class="checkout-body">
        ...
        <form id="checkout-form" class="checkout-form">
          ...
          <div class="payment-method-section">
            <h4><i class="fas fa-university"></i> Payment Method</h4>
              ...
              <label class="payment-method-option">
                ...
                <span class="payment-method-label">
                  ...
                  <span>
                    ...
                    <small>Pay via GTBank, Opay, or Moniepoint</small>
                  </span>
                </span>
              </label>
            </div>
